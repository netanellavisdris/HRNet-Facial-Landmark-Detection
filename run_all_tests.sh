    ...
    do
        ...
        do
            ...
            do
                ...
                # Run the test script
                echo "Running test with MODEL_DATASET: $MODEL_DATASET, CFG_DATASET: $CFG_DATASET, STRUCTURE: $STRUCTURE, METRIC: $METRIC"
                python tools/test.py --cfg "$CFG_FILE" --model-file "$MODEL_FILE"
                echo "Finished testing with MODEL_DATASET: $MODEL_DATASET, CFG_DATASET: $CFG_DATASET, STRUCTURE: $STRUCTURE, METRIC: $METRIC"
                echo "---------------------------------------------"
            done
        done
    done
