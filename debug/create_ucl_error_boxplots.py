...
# Define paths
base_dir = "/cdivece/workspace/fetalbiometry_paper"
data_dir = os.path.join(base_dir, "fetalbiometrydata")
output_dir = os.path.join(base_dir, "HRNet-Facial-Landmark-Detection-Dev/output/FETAL")
